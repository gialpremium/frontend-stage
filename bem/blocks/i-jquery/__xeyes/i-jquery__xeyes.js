    ...
    this.each( function( index, iris ) {
        ...
        var offset = $iris.offset(),
            ...
            position = {
                ...
                topRight    : { degree: 45 },
                topLeft     : { degree: 135 },
                bottomRight : { degree: -45 },
                bottomLeft  : { degree: -135 },
            };
        ...
        $( options.trigger ).mousemove( function( e ) {
            ...
            var newLeft, 
                newTop,
                degree = Math.atan( ( e.pageY - offY ) / ( e.pageX - offX ) ),
            ...
            if ( radius > distance && options.onHover.toLowerCase() != 'nofollow' ) {
                newLeft = e.pageX - offX + defX;
                if ( $iris.hasClass('main-iris') ) {
                    mainTop = e.pageY - offY + defY;   
                }
            }
            else {
                newLeft = defX + newX;
            ...
            $iris.css( 'left', newLeft + 'px' ).css( 'top', mainTop + 'px' );
        } );
    } );
};
